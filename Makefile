...
COM_PIPS    = grpcio~=1.25.0 grpcio-tools~=1.25.0 pymacaroons~=0.13.0 macaroonbakery~=1.2.3 pylibscrypt~=1.8.0 pynacl~=1.3.0 click~=7.0 protobuf~=3.10.0 SQLAlchemy~=1.3.10 alembic~=1.2.1
